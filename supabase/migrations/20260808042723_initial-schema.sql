...
GRANT MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE ON public.areas TO anon;

GRANT MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE ON public.areas TO authenticated;
...
GRANT MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE ON public.houses TO anon;

GRANT MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE ON public.houses TO authenticated;
...
GRANT MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE ON public.surfaces TO anon;

GRANT MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE ON public.surfaces TO authenticated;
...
ALTER TABLE public.tiles
  ADD CONSTRAINT tiles_pkey PRIMARY KEY (sku);

ALTER TABLE public.surfaces
  ADD CONSTRAINT surfaces_selected_tile_fkey FOREIGN KEY (selected_tile) REFERENCES public.tiles(sku) ON DELETE SET NULL;

GRANT MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE ON public.tiles TO anon;

GRANT MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE ON public.tiles TO authenticated;
